...
EC2 storage options based on durability, performance, cost, and use cases to guide architectural decisions.
...
| Best use cases                   | Databases, root volumes,    | Shared content,                  | Scratch space, caches,      |
|                                  | single-instance apps        | multi-instance access            | temporary data              |
